#!/usr/bin/env python3
"""
Test direct ReportLab PDF generation with improved equation rendering
"""
...
def main():
    ...
    # Create a list of equations to test
    equations = [
        {
    ...
    output_file = "gfx/pdf/direct_reportlab_test.pdf"
    ...
    elements.append(Paragraph("This document tests the improved rendering of complex mathematical equations in PDF output using ReportLab with Unicode conversion.", styles['Normal']))
    elements.append(Spacer(1, 12))
    ...
    if os.path.exists(output_file):
        ...
        print("\nThe PDF file contains improved equation rendering with Unicode symbols.")
