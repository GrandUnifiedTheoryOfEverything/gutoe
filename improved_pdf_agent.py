#!/usr/bin/env python3
"""
Improved PDF Agent with Specialized Math Formula Rendering

This module provides an improved PDF agent with specialized math formula rendering,
graphics capabilities, and better display of mathematical equations.
"""
...
# Import the specialized math formula renderer
from math_formula_renderer import MathFormulaRenderer, create_formula_paragraph

class ImprovedPDFAgent:
    """
    Improved PDF Agent with Specialized Math Formula Rendering
    
    This class provides methods for generating PDFs with advanced features:
    - Specialized math formula rendering for proper display of equations
    ...
    def __init__(self, output_dir="docs/pdf"):
        """
        Initialize the improved PDF agent
    ...
    def generate_complete_theory_pdf(self):
        ...
        with specialized math formula rendering and graphics
        ...
        # Add each equation with specialized rendering
        ...
        try:
            doc.build(elements)
            print(f"Improved Complete Theory of Everything PDF saved to: {output_file}")
            return output_file
