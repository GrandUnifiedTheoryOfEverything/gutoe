#!/usr/bin/env python3
"""
Generate a coherent PDF for Maxwell's Equations with proper formatting and subscripts
"""
...
def main():
    """Generate a coherent PDF for Maxwell's Equations with proper subscripts"""
    ...
    # Maxwell's Equations with HTML subscripts
    maxwell_equations = [
        {
            "name": "Gauss's Law for Electricity",
            "equation": "∇·E = ρ/ε<sub>0</sub>",
        ...
        },
        {
            ...
            "equation": "∇×B = μ<sub>0</sub>J + μ<sub>0</sub>ε<sub>0</sub>∂E/∂t",
    ...
    elements.append(Paragraph(
        "The speed of electromagnetic waves in vacuum can be derived from Maxwell's equations as c = 1/√(ε<sub>0</sub>μ<sub>0</sub>), "
        "which is approximately 3 × 10<sup>8</sup> m/s.", normal_style))
    elements.append(Spacer(1, 6))
